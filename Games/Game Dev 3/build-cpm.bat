...
zcc +cpm -subtype=nabu -vn -lm -lndos -llib3d -create-app -compiler=sdcc -O3 --opt-code-speed main.c -o "game3"
...
cpmcp -f naburn    "C:\My Documents\NABU Internet Adapter\Store\a.dsk" game3.com 0:
