...
zcc +cpm -subtype=nabu -vn -lm -lndos -llib3d -create-app -compiler=sdcc -O3 --opt-code-speed main.c -o "game2"
...
cpmcp -f naburn    "C:\My Documents\NABU Internet Adapter\Store\a.dsk" game2.com 0:
